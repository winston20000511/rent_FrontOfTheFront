...
<template>
  <div class="border border-gray-400 py-2 px-2 rounded-md">
    <div class="table-container over-flow-y-auto max-h-96">
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-4 py-3 text-sm text-center text-gray-700">
              {{ order.merchantTradDate }}
            </td>
            <td class="px-4 py-3 text-sm text-center text-gray-700">
              <span
                v-if="order.orderStatus === '一般訂單'"
                class="inline-block px-2 py-1 text-xs font-medium rounded-full bg-yellow-100 text-yellow-800"
              ...
              >
              <span
                v-if="order.orderStatus === '取消中'"
                class="inline-block px-2 py-1 text-xs font-medium rounded-full bg-pink-100 text-pink-800"
                >{{ order.orderStatus }}</span
              >
            </td>
            <td class="px-4 py-3 text-sm text-center text-gray-700">
            ...
            <td class="px-4 py-3 text-center">
              <button
                class="px-3 py-1 mr-1 text-sm text-blue-600 bg-blue-100 rounded hover:bg-blue-200"
                @click="check(order.merchantTradNo)"
              >
                詳細
              </button>
              <button
                ...
                @click="cancel(order.merchantTradNo)"
              >
                取消
              </button>
              <button
