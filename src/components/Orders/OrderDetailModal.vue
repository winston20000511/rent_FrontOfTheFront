...
<template>
    ...
    <div
      class="fixed inset-0 z-20 bg-gray-500/75 flex items-center justify-center" @click="closeDetail"
    >
      <div class="bg-white rounded-lg shadow-lg w-4/5 h-4/5 p-8"  @click.stop>
            ...
            <thead class="border border-gray-400">
              <tr>
                ...
                <td colspan="3" class="px-4 py-2">
                  {{ detail.merchantTradNo }}
                </td>
              </tr>
              <tr>
                <th class="bg-gray-100 text-center">付款日期</th>
                <td colspan="3" class="px-4 py-2">
                  {{ detail.merchantTradDate }}
                </td>
              </tr>
              <tr>
