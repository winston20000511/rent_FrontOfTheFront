...
import OrderPopUpMessage from '@/components/Orders/OrderPopUpMessage.vue';
...
let detail = reactive({});
let showOverlay = reactive(false);
...
<template>
  ...
  <OrderDetailModal v-if="showOrderDetail" :detail="detail" @close-detail="closeOrderDetail" />
  <OrderPopUpMessage v-if="showMessage" :messageTitle="messageTitle" :message="messageContent" @close-message="closeMessage" />
</template>
